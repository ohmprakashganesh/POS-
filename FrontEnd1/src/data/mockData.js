...
export const DUMMY_PRODUCTS = [
  {
    ...
    description:
      "Apple’s MacBook Pro M1 Pro 14-inch delivers exceptional performance for creative professionals with a high-resolution display and powerful M1 Pro chip.",
  ...
  },
  {
    ...
    expiry_date: "2030-10-23",
    description:
      "MSI 27-inch 4K monitor featuring ultra-high definition, modern design, and accurate color calibration — ideal for productivity and content creation.",
    tags: ['MSI', 'Monitor', 'Electronic'],
  },
  {
    id: 3,
    category: "Accessories",
    ...
    expiry_date: "2030-10-23",
    description:
      "The 13-inch MacBook Pro with Apple’s M1 chip delivers blazing-fast performance, great battery life, and professional-grade efficiency for daily work.",
    tags: ['Apple', 'Laptop', 'Electronic'],
  },
  {
    id: 4,
    category: "Laptop",
    ...
    expiry_date: "2030-10-23",
    description:
      "A sleek and modern MSI 27-inch 4K display, offering ultra-clear visuals and productivity-optimized features for developers and designers.",
    tags: ['MSI', 'Monitor', 'Electronic'],
  },
  {
    id: 5,
    ...
    expiry_date: "2030-10-23",
    description:
      "The MacBook Pro M1 Pro 14-inch redefines power and portability, ideal for programmers, creators, and financial analysts needing high performance.",
    tags: ['Apple', 'Laptop', 'Electronic'],
  },
  {
    id: 6,
    ...
    expiry_date: "2030-10-23",
    description:
      "The 14-inch MacBook Pro with M1 Pro chip offers high-end performance and a beautiful Liquid Retina XDR display for professional-grade tasks.",
    tags: ['Apple', 'Laptop', 'Electronic'],
  },
  {
    id: 7,
    ...
    expiry_date: "2030-10-23",
    description:
      "The MacBook Air M1 13-inch combines efficiency, lightweight design, and silent operation — perfect for everyday tasks and on-the-go productivity.",
    tags: ['Apple', 'Laptop', 'Electronic'],
  },
];
