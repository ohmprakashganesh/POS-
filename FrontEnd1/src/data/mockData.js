...
export const DUMMY_PRODUCTS = [
  {
    ...
    description: "A high-performance MacBook Pro featuring the M1 Pro chip, excellent for productivity, editing, and professional workloads."
  },
  {
    id: 2,
    category: "Accessories",
    ...
    purchase_date: "2025-10-23",
    expiry_date: "2030-10-23",
    description: "A premium 27-inch MSI 4K monitor with ultra-clear visuals, ideal for creative work and modern office setups."
  },
  {
    id: 3,
    category: "Accessories",
    ...
    purchase_date: "2025-10-23",
    expiry_date: "2030-10-23",
    description: "Lightweight and powerful MacBook Pro M1 with long battery life, suitable for students and professionals."
  },
  {
    id: 4,
    category: "Laptop",
    ...
    purchase_date: "2025-10-23",
    expiry_date: "2030-10-23",
    description: "Crystal-clear 4K resolution and sleek design make this MSI monitor ideal for productivity and home offices."
  },
  {
    id: 5,
    category: "Laptop",
    ...
    purchase_date: "2025-10-23",
    expiry_date: "2030-10-23",
    description: "A powerful MacBook Pro 14-inch model built with M1 Pro technology for heavy multitasking and pro-level performance."
  },
  {
    id: 6,
    category: "Laptop",
    ...
    purchase_date: "2025-10-23",
    expiry_date: "2030-10-23",
    description: "A premium 14-inch MacBook equipped with the M1 Pro chip delivering smooth performance for all workflows."
  },
  {
    id: 7,
    category: "Laptop",
    ...
    purchase_date: "2025-10-23",
    expiry_date: "2030-10-23",
    description: "Lightweight, silent, and energy-efficient MacBook Air powered by the M1 chip—perfect for everyday users."
  }
];
