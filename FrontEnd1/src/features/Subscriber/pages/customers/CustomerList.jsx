      ...
      <div className="overflow-x-auto bg-white dark:bg-dark rounded-md shadow-sm">
        <table className="min-w-full text-sm text-muted">
          <thead className="uppercase  text-sm text-left  bg-secondary text-secondary-foreground">
            <tr>
              <th className="p-4 w-6">{t("customer.sn")}</th>
              <th className="p-4">{t("customer.name")}</th>
              <th className="p-4">{t("customer.phone")}</th>
              <th className="p-4">{t("customer.email")}</th>
              <th className="p-4">{t("customer.address")}</th>
              <th className="p-4">{t("customer.totalOrders")}</th>
              <th className="p-4">{t("customer.totalSpent")}</th>
              <th className="p-4">{t("customer.actions")}</th>
            </tr>
          </thead>
