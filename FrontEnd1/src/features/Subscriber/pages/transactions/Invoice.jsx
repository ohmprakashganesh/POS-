  ...
  return (
    invoice && (
      <>
        ...
        <div className="bill animate-fade-slide-in w-[95dvw] overflow-auto  max-w-4xl max-h-4/5 bg-white dark:bg-dark shadow-sm p-3 z-100 rounded-md mx-auto fixed top-1/2 left-1/2 -translate-1/2">
          {/* Header Section */}
