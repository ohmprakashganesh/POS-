...
//     end: ''
//   });
//   const HeaderFields=["invoiceNo","customer","Date","items","Total","status","actions"];
...
//       <div>
//         <h1 className="text-2xl font-bold text-gray-900">{t("transactions.transactionHistory")}</h1>
...
//                 return<th key={ind} className="p-4">
//                   {head}
//                 </th>
//                 })}
//               </tr>
