...
const CProduct = () => {
  ...
  if (!productData) {
    return (
      <div className="max-w-5xl mx-auto p-6 sm:p-8 lg:p-12 bg-white dark:bg-gray-900 shadow-xl rounded-2xl text-center">
  ...
  return (
    <div className="max-w-7xl mx-auto p-4 sm:p-6 lg:p-10 bg-white dark:bg-gray-900 shadow-lg rounded-2xl">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-5 gap-6 lg:gap-10 mb-8 lg:mb-12">
        ...
        {/* DETAILS SECTION */}
        <div className="lg:col-span-3 space-y-6 text-gray-800 dark:text-gray-100">
          ...
          {productData.tags && (
            <div>
              <label className="text-base font-semibold text-gray-900 dark:text-gray-100 block mb-3">
                Tags:
